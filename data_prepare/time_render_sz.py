...
def render_by_time(dfs):
    ...
    # for df in dfs:
        ...
        dspeed = []
        for l in df:
            if 0 <= l[1] < 1024 and 0 <= l[2] < 1024: #TODO:sz_1024size数据集的经纬度和速度在dataframe中的位置变了
                # print(t[3], t[4])
...
if __name__ == "__main__":
    ...
    for file_name in iterater:
        ...
        save_path = "/home/fk/python_code/datasets/dataset_sz_grid/GPS/taxi_direct_render"
        ...
        # #渲染时间、数量、速度信息 高斯核
        # gps_image_array2 = _time_quantity_speed_render(patchedGPS)
        # save_path = "/home/fk/python_code/datasets/dataset_sz_grid/GPS/taxi_filtered_time_quantity_speed_patch"
        # os.makedirs(save_path, exist_ok=True)
        # cv2.imwrite(os.path.join(save_path, f"{file_name[:-8]}_gps.png"), gps_image_array2)
