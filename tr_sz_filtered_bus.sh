...
for w in "${weight_save_dir[@]}"; do
    for m in "${models[@]}"; do
        ...
        #     --gps_dir ../datasets/dataset_sz_grid/GPS/bus \
        #     \
        #     --gps_type data \
        ...
        ts -G "${n}" python train.py \
            ...
            --test_mask_dir ../datasets/dataset_sz_grid/test/mask \
            --gps_dir ../datasets/dataset_sz_grid/GPS/bus_filtered_time_quantity_speed_patch \
            \
            --gps_type image \
        ...
        ts -G "${n}" python train.py \
            ...
            --test_sat_dir ../datasets/dataset_sz_grid/test/image_test \
            --test_mask_dir ../datasets/dataset_sz_grid/test/mask \
            --gps_dir ../datasets/dataset_sz_grid/GPS/bus_filtered_time_quantity_speed_gaussian_patch/ \
            \
            --gps_type image \
